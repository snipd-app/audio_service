...
public class AudioServiceConfig {
    ...
    private static final String KEY_ANDROID_PAUSE_EXIT_FOREGROUND_DELAY_MS = "androidPauseExitForegroundDelayMs";
    ...
    public long androidPauseExitForegroundDelayMs;
    ...
    public AudioServiceConfig(Context context) {
        ...
        androidPauseExitForegroundDelayMs = preferences.getLong(KEY_ANDROID_PAUSE_EXIT_FOREGROUND_DELAY_MS, 5000L);
    ...
    public void save() {
        preferences.edit()
            ...
            .putLong(KEY_ANDROID_PAUSE_EXIT_FOREGROUND_DELAY_MS, androidPauseExitForegroundDelayMs)
